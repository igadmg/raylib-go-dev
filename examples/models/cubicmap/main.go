...
func main() {
	...
	camera := rl.Camera{}
	camera.Position = vector3.MakeFloat32(16.0, 14.0, 16.0)
	...
	mesh := rl.GenMeshCubicmap(image, vector3.MakeFloat32(1.0, 1.0, 1.0))
	...
	for !rl.WindowShouldClose() {
		...
		rl.DrawTextureEx(cubicmap, vector2.MakeFloat32(float32(screenWidth-cubicmap.Width*4-20), 20), 0.0, 4.0, rl.White)
