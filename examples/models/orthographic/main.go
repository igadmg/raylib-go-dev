...
func main() {
	...
	for !rl.WindowShouldClose() {
		...
		rl.DrawCube(vector3.MakeFloat32(-4, 0, 2), 2, 5, 2, rl.Red)
		rl.DrawCubeWires(vector3.MakeFloat32(-4, 0, 2), 2, 5, 2, rl.Gold)
		rl.DrawCubeWires(vector3.MakeFloat32(-4, 0, -2), 3, 6, 2, rl.Maroon)

		rl.DrawSphere(vector3.MakeFloat32(-1, 0, -2), 1, rl.Green)
		rl.DrawSphereWires(vector3.MakeFloat32(1, 0, 2), 2, 16, 16, rl.Lime)

		rl.DrawCylinder(vector3.MakeFloat32(4, 0, -2), 1, 2, 3, 4, rl.SkyBlue)
		rl.DrawCylinderWires(vector3.MakeFloat32(4, 0, -2), 1, 2, 3, 4, rl.DarkBlue)
		rl.DrawCylinderWires(vector3.MakeFloat32(4.5, -1, 2), 1, 1, 2, 6, rl.Brown)

		rl.DrawCylinder(vector3.MakeFloat32(1, 0, -4), 0, 1.5, 3, 8, rl.Gold)
		rl.DrawCylinderWires(vector3.MakeFloat32(1, 0, -4), 0, 1.5, 3, 8, rl.Pink)
