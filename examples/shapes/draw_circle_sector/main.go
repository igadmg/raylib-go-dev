...
func main() {
	...
	for !rl.WindowShouldClose() { // Detect window close button or ESC key
		...
		// Draw GUI controls
		r := rect2.MakeFloat32(vector2.MakeFloat32(600, 40), vector2.MakeFloat32(120, 20))
		msg := fmt.Sprintf("%.2f", startAngle)
		startAngle = gui.Slider(r, "StartAngle", msg, startAngle, 0, 720)

		r = rect2.MakeFloat32(vector2.MakeFloat32(600, 70), vector2.MakeFloat32(120, 20))
		msg = fmt.Sprintf("%.2f", endAngle)
		endAngle = gui.Slider(r, "EndAngle", msg, endAngle, 0, 720)

		r = rect2.MakeFloat32(vector2.MakeFloat32(600, 140), vector2.MakeFloat32(120, 20))
		msg = fmt.Sprintf("%.2f", outerRadius)
		outerRadius = gui.Slider(r, "Radius", msg, outerRadius, 0, 200)

		r = rect2.MakeFloat32(vector2.MakeFloat32(600, 170), vector2.MakeFloat32(120, 20))
