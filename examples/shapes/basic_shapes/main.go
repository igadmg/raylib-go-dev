...
func main() {
	...
	for !rl.WindowShouldClose() {
		...
		rl.DrawTriangle(vector2.MakeFloat32(float32(screenWidth)/4*3, 80),
			vector2.MakeFloat32(float32(screenWidth)/4*3-60, 150),
			vector2.MakeFloat32(float32(screenWidth)/4*3+60, 150), rl.Violet)

		rl.DrawTriangleLines(vector2.MakeFloat32(float32(screenWidth)/4*3, 160),
			vector2.MakeFloat32(float32(screenWidth)/4*3-20, 230),
			vector2.MakeFloat32(float32(screenWidth)/4*3+20, 230), rl.DarkBlue)

		rl.DrawPoly(vector2.MakeFloat32(float32(screenWidth)/4*3, 320), 6, 80, 0, rl.Brown)
