...
func main() {
	...
	floor := physics.NewBodyRectangle(vector2.MakeFloat32(screenWidth/2, screenHeight), screenWidth, 100, 10)
	platformLeft := physics.NewBodyRectangle(vector2.MakeFloat32(screenWidth*0.25, screenHeight*0.6), screenWidth*0.25, 10, 10)
	platformRight := physics.NewBodyRectangle(vector2.MakeFloat32(screenWidth*0.75, screenHeight*0.6), screenWidth*0.25, 10, 10)
	wallLeft := physics.NewBodyRectangle(vector2.MakeFloat32(-5, screenHeight/2), 10, screenHeight, 10)
	wallRight := physics.NewBodyRectangle(vector2.MakeFloat32(screenWidth+5, screenHeight/2), 10, screenHeight, 10)
	...
	body := physics.NewBodyRectangle(vector2.MakeFloat32(screenWidth/2, screenHeight/2), 50, 50, 1)
	...
	for !rl.WindowShouldClose() {
		...
		if rl.IsKeyPressed(rl.KeyR) { // Reset physics input
			...
			body.Position = vector2.MakeFloat32(screenWidth/2, screenHeight/2)
			body.Velocity = vector2.MakeFloat32(0, 0)
			body.SetRotation(0)
		}
