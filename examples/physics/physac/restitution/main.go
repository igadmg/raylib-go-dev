...
func main() {
	...
	circleA := physics.NewBodyCircle(vector2.MakeFloat32(screenWidth*0.25, screenHeight/2), 30, 10)
	circleA.Restitution = 0
	circleB := physics.NewBodyCircle(vector2.MakeFloat32(screenWidth*0.5, screenHeight/2), 30, 10)
	circleB.Restitution = 0.5
	circleC := physics.NewBodyCircle(vector2.MakeFloat32(screenWidth*0.75, screenHeight/2), 30, 10)
	...
	for !rl.WindowShouldClose() {
		...
		if rl.IsKeyPressed(rl.KeyR) { // Reset physics input
			...
			circleA.Position = vector2.MakeFloat32(screenWidth*0.25, screenHeight/2)
			circleA.Velocity = vector2.MakeFloat32(0, 0)
			circleB.Position = vector2.MakeFloat32(screenWidth*0.5, screenHeight/2)
			circleB.Velocity = vector2.MakeFloat32(0, 0)
			circleC.Position = vector2.MakeFloat32(screenWidth*0.75, screenHeight/2)
			circleC.Velocity = vector2.MakeFloat32(0, 0)
		}
