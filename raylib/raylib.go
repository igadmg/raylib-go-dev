...
func (t *Texture2D) DrawMaskedEx(mask *Texture2D, position Vector2, rotation, scale float32, tint color.RGBA) {
	BeginBlendCustomSeparateMode(BlendZero, BlendOne, BlendSrcColor, BlendZero, BlendFuncAdd, BlendFuncAdd)
	mask.DrawEx(position, rotation, scale, tint)

	BeginBlendCustomSeparateMode(BlendDstAlpha, BlendOneMinusDstAlpha, BlendSrcAlpha, BlendZero, BlendFuncAdd, BlendFuncAdd)
